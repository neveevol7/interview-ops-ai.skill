# Interview-Ops-AI 🚀 | 面试深度适配 Skill

[**中文版**](#-快速上手) | [**English Version**](#-quick-start-en)
...
1. **获取指令**：复制本仓库中 [`core-engine.md`](./core-engine.md) 的全部内容。
2. **运行 Skill**：将内容发送给 **Gemini, ChatGPT 或 Claude**。
3. **输入数据**：按照 AI 引导提供简历、JD、面试轮次及薪资。
